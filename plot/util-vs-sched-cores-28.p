...
set output "util-vs-sched-cores-28.tex"
set title "Utilization vs. Schedulability Ratio for m=28"

file="../sched-util/util-sum-by-cores.dat"
# $2 == 28 <-- number of cores
cmd="< awk '{if ($2 == 28) print}' ../sched-util/util-sum-by-cores.dat"
