...
set output "util-vs-sched-cores-20.tex"
set title "Utilization vs. Schedulability Ratio for m=20"

file="../sched-util/util-sum-by-cores.dat"
# $2 == 20 <-- number of cores
cmd="< awk '{if ($2 == 20) print}' ../sched-util/util-sum-by-cores.dat"
