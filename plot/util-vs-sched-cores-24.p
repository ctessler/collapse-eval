...
set output "util-vs-sched-cores-24.tex"
set title "Utilization vs. Schedulability Ratio for m=24"

file="../sched-util/util-sum-by-cores.dat"
# $2 == 24 <-- number of cores
cmd="< awk '{if ($2 == 24) print}' ../sched-util/util-sum-by-cores.dat"
