...
set output "util-vs-sched-cores-12.tex"
set title "Utilization vs. Schedulability Ratio for m=12"

file="../sched-util/util-sum-by-cores.dat"
# $2 == 12 <-- number of cores
cmd="< awk '{if ($2 == 12) print}' ../sched-util/util-sum-by-cores.dat"
