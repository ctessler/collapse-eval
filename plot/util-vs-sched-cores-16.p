...
set output "util-vs-sched-cores-16.tex"
set title "Utilization vs. Schedulability Ratio for m=16"

file="../sched-util/util-sum-by-cores.dat"
# $2 == 16 <-- number of cores
cmd="< awk '{if ($2 == 16) print}' ../sched-util/util-sum-by-cores.dat"
